...
import { FaMapMarkerAlt, FaCalendarAlt, FaUsers, FaBriefcase, FaDollarSign, FaLaptopHouse } from "react-icons/fa";
                ...
                <Box sx={{ mt: 4 }}>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} md={6}>
                            <Paper elevation={0} sx={{ p: 2, bgcolor: "background.default" }}>
                                <Grid container alignItems="center" spacing={1}>
                                    <Grid item><FaBriefcase /></Grid>
                                    <Grid item>
                                        <Typography variant="body1">
                                            <strong>Experience:</strong> {jobData.experienceYears}+ years
                                        </Typography>
                                    </Grid>
                                </Grid>
                            </Paper>
                    ...
                    <Grid container spacing={2} alignItems="center">
                        <Grid item xs={12} sm={6}>
                            ...
                            <Typography variant="body1" sx={{ mt: 1 }}>
                                <FaCalendarAlt /> Application Deadline: {new Date(jobData.endDate).toLocaleDateString()}
                            </Typography>
                        </Grid>
